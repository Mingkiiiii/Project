	...
	if (is_array($_FILES['image']['tmp_name'])) {
		...
		foreach ($_FILES['image']['tmp_name'] as $k => $image) {
			...
			if ($file_type === "image/jpeg" || $file_type === "image/png" || $file_type === "image/gif") {
				...
				move_uploaded_file($_FILES['image']['tmp_name'][$k], "{$_SERVER['DOCUMENT_ROOT']}/uploads/recipe/{$banner_name}");
			} else die('에러');
		}
		...
		if ($file_type === "image/jpeg" || $file_type === "image/png" || $file_type === "image/gif") {
			...
			move_uploaded_file($_FILES['image']['tmp_name'], "{$_SERVER['DOCUMENT_ROOT']}/uploads/recipe/{$banner_name}");
